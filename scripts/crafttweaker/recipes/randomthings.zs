...
removeAndHide(<randomthings:spectrecoil_normal>);
removeAndHide(<randomthings:spectrecoil_redstone>);
removeAndHide(<randomthings:spectrecoil_ender>);
...
removeAndHide(<randomthings:spectrecore>);
removeAndHide(<randomthings:spectreenergyinjector>);
